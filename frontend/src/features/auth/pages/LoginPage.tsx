...
export const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (errorParam === 'OAuthNotConfigured') {
      setError('Social login is not configured on the server yet.');
      ...
      <div className="glass-card" style={{ width: '100%', maxWidth: '400px', padding: '2.5rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <button 
            type="button" 
            className="btn" 
            style={{ backgroundColor: 'white', color: '#000', border: '1px solid #e2e8f0' }}
          ...
          >
            <svg viewBox="0 0 24 24" width="20" height="20" style={{ marginRight: '0.5rem', fill: 'currentColor' }}>
